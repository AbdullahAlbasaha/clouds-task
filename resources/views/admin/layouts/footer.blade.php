<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-{{Carbon\Carbon::now()->year}} <a href="http://almsaeedstudio.com">Abdullah Albasha</a>.</strong> All rights
    reserved.
</footer>
...
<!-- Sparkline -->
<script src="{{asset('admins/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{asset('admins/plugins/knob/jquery.knob.js')}}"></script>
<!-- daterangepicker -->
